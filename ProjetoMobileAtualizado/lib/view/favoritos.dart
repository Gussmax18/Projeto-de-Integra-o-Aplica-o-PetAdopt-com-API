                    ...
                    Expanded(
                      child: GridView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          // Selecionando a primeira imagem se `pet.images` for uma lista.
                          final imageUrl = (pet.images is List && pet.images.isNotEmpty)
                              ? pet.images.first
                              : 'https://via.placeholder.com/150';

                          return GestureDetector(
                            onTap: () {
                              // Implementar a navegação para detalhes do pet
                              // Exemplo:
